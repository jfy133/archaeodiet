//
// Sort, index BAM file and run samtools stats, flagstat and idxstats - from https://github.com/nf-core/viralrecon/blob/master/subworkflows/nf-core/bam_sort_samtools.nf
//
