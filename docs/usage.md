...
```console
nextflow run jfy133/archaeodiet --input samplesheet.csv --genome GRCh37 -profile docker
```
...
```console
nextflow pull jfy133/archaeodiet
```
...
This pipeline supports the use of nf-core/configs.
